...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 21.0, 210.0, 48.0, 22.0 ],
					"text" : "del 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 21.0, 182.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 120.0, 182.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 253.0, 45.0, 22.0 ],
					"text" : "store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 253.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					"autorestore" : "GIMLeT_temporal_example_settings.json",
					"id" : "obj-11",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 299.0, 354.0, 22.0 ],
					"saved_object_attributes" : 					{
						"client_rect" : [ 4, 44, 358, 172 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0,
						"storage_rect" : [ 0, 79, 840, 1016 ]
					}
,
					"text" : "pattrstorage GIMLeT_temporal_example_settings @savemode 3",
					"varname" : "GIMLeT_temporal_example_settings"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 381.0, 18.5, 289.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.0, 41.5, 114.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.0, 253.0, 89.0, 22.0 ],
					"text" : "storagewindow"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 525.5, 39.433350000000019, 662.5, 39.433350000000019 ],
					"source" : [ "obj-236", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-5::obj-42" : [ "live.text[55]", "live.text", 0 ],
			"obj-2::obj-5::obj-62" : [ "number[26]", "number[3]", 0 ],
			"obj-2::obj-5::obj-7" : [ "gswitch2", "gswitch2", 0 ],
			"obj-2::obj-5::obj-8" : [ "live.text[54]", "live.text", 0 ],
...
, 			{
				"name" : "GIMLeT_temporal_example_settings.json",
