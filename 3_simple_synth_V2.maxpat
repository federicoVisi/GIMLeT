...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 180.978413899739678, 623.4375, 100.0, 38.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"id" : "obj-38",
					"items" : [ "/groups/mygroup/qom", ",", "/points/stick/vel_mag", ",", "/points/stick/rot_rpy" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 225.379384160041809, 86.865384459495544, 89.89508056640625, 21.0 ],
					"text" : "Sound Design",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 673.75006103515625, 390.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 537.25, 573.5, 100.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 282.5, 609.5, 73.854919433593722, 114.125 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.60491943359375, 181.360595703125, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 453.0, 329.1878662109375, 81.0, 22.0 ],
									"text" : "s bufferlength"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 208.0, 53.1878662109375, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 361.790161999999896, 252.1878662109375, 114.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 208.0, 180.1878662109375, 42.0, 22.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 222.0, 252.1878662109375, 109.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 403.790161999999896, 329.1878662109375, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 222.0, 317.1878662109375, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 240.5, 212.1878662109375, 32.0, 212.1878662109375, 32.0, 97.1878662109375, 59.5, 97.1878662109375 ],
									"source" : [ "obj-71", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 473.39508056640625, 468.0, 38.0, 112.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 5928.22916666666606, "ms" ],
						"loopstart" : [ 5291.45833333333303, "ms" ],
						"mode" : "basic",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 271.5, 198.65789794921875, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 473.39508056640625, 609.5, 35.0, 22.0 ],
					"text" : "dac~"
				}
