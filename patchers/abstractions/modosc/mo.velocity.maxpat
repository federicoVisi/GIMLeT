...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 52.764816, 755.0, 36.0 ],
					"style" : "",
					"text" : "Runs the Skogstad low-pass-filtered (i.e. noise reduced) first differentiator to calculate velocity from position.\nThe amount of filtering, specififed as [1,2,3,4, or 5], corresponds to normalized cutoff frequencies of [0.5, 0.4, 0.3, 0.2, and 0.1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 426.5, 131.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.5, 131.286255, 227.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 398.0, 189.115753, 57.0, 22.0 ],
					"style" : "",
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.5, 131.286255, 63.0, 20.0 ],
					"style" : "",
					"text" : "data input"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 130.875473, 29.5, 22.0 ],
									"style" : "",
									"text" : "+ 6"
								}
...
,
					"patching_rect" : [ 158.75, 200.115753, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.75, 125.764816, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.75, 164.240295, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 1214.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.25, 125.764816, 105.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.5, 344.5, 63.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 731.0, 279.5, 263.0, 73.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 158.75, 230.0, 96.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 158.75, 259.0, 510.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 21.0, 1163.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "o.route /state"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 762.0, 254.5, 281.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 21.0, 425.5, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 21.0, 376.5, 30.0, 22.0 ],
					"style" : "",
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 707.5, 243.811462, 42.5, 22.0 ],
					"style" : "",
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 83.5, 424.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "o.var"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 707.5, 203.696167, 215.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 757.0, 133.866699, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 707.5, 128.866699, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 398.0, 160.866699, 74.0, 22.0 ],
					"style" : "",
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 398.0, 131.286255, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 707.5, 174.115753, 85.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /points"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 21.0, 468.0, 921.0, 684.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 20.5, 311.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.5, 1006.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.5, 125.764816, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 168.25, 328.0, 114.625, 328.0, 114.625, 300.0, 61.0, 300.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 717.0, 335.861633, 74.0, 335.861633 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 740.5, 392.5, 111.0, 392.5 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 409.5, 93.0, 409.5 ],
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 717.0, 165.991226, 717.0, 165.991226 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 407.5, 221.115753, 287.875, 221.115753, 287.875, 159.240295, 168.25, 159.240295 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 445.5, 221.115753, 581.25, 221.115753, 581.25, 165.115753, 717.0, 165.115753 ],
					"source" : [ "obj-51", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 93.0, 456.0, 75.75, 456.0, 75.75, 414.5, 61.5, 414.5 ],
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-86", 1 ],
					"midpoints" : [ 30.5, 1195.0, 976.5, 1195.0, 976.5, 410.5, 111.0, 410.5 ],
					"source" : [ "obj-93", 0 ]
				}
