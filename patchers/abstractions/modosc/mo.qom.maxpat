...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 52.764816, 755.0, 50.0 ],
					"style" : "",
					"text" : "Group descriptor. Calculates the quantity of motion (QoM) of the points in the group. Example: [mo.qom group_name] calculates the QoM of the points in group_name and stores it in /modosc/groups/group_name/qom: f. Requires that the velocity for each point in the group has been calculated upstream using mo.velocity."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 120.286255, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 68.0, 149.866699, 74.0, 22.0 ],
					"style" : "",
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 68.0, 120.286255, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 618.0, 160.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.0, 435.0, 160.0, 33.0 ],
					"style" : "",
					"text" : "Delete addresses we made in the previous stage"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 120.286255, 300.0, 20.0 ],
					"style" : "",
					"text" : "Status:Tested on fake data. Needs testing w real data."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 124.866699, 224.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 68.0, 180.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /args"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 631.0, 313.0, 20.0 ],
					"style" : "",
					"text" : "Calc qom, add to new address, and delete temp vars"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 762.0, 663.5, 178.0, 141.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 21.5, 593.0, 117.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.5, 427.0, 339.0, 20.0 ],
					"style" : "",
					"text" : "Do all the points in the list exist and have velocity data?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 738.0, 473.0, 202.0, 73.0 ],
					"text" : "delete(/process),\ndelete(/grp_pnts_addr),\ndelete(/groupName),\ndelete(/pnts)",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 224.0, 284.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 21.5, 377.0, 117.0, 22.0 ],
					"style" : "",
					"text" : "o.if /process == true"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 21.5, 262.0, 842.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 21.5, 224.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.5, 1022.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.5, 116.0, 30.0, 30.0 ],
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 177.5, 175.643127, 77.5, 175.643127 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 129.0, 417.0, 747.5, 417.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 747.5, 983.0, 31.0, 983.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 129.0, 624.0, 771.5, 624.0 ],
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 771.5, 1000.0, 31.0, 1000.0 ],
					"source" : [ "obj-32", 0 ]
				}
